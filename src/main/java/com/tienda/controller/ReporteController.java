...
public class ReporteController {
    ...
    @GetMapping("/Articulos")//agrego articulos como reporte 
    public ResponseEntity<Resource> reporteArticulos(@RequestParam String tipo) 
            throws IOException {
        var reporte="Articulos";
        return reporteService.generaReporte(reporte, null, tipo);
    }
    
    @GetMapping("/Categorias")//agrego categoria como reporte
